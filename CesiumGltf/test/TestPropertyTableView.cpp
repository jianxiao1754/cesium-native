...
TEST_CASE("Test PropertyTableView on model with nonexistent class") {
  Model model;
...
TEST_CASE("Test PropertyTableView on scalar property") {
  Model model;
...
TEST_CASE("Test PropertyTableView on vecN property") {
  Model model;
...
TEST_CASE("Test PropertyTableView on matN property") {
  Model model;
...
TEST_CASE("Test PropertyTableView on boolean property") {
  Model model;
...
TEST_CASE("Test PropertyTableView on string property") {
  Model model;
...
TEST_CASE("Test PropertyTableView on fixed-length scalar array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on variable-length scalar array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on fixed-length vecN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on variable-length vecN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on fixed-length matN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on variable-length matN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on fixed-length boolean array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on variable-length boolean array") {
  Model model;
...
TEST_CASE("Test PropertyTableView on fixed-length arrays of strings") {
  Model model;
...
TEST_CASE("Test PropertyTableView on variable-length arrays of strings") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback on invalid property table view") {
  Model model;
  ExtensionModelExtStructuralMetadata& metadata =
      model.addExtension<ExtensionModelExtStructuralMetadata>();
...
TEST_CASE("Test PropertyTableView with callback for invalid property") {
  Model model;
  ExtensionModelExtStructuralMetadata& metadata =
      model.addExtension<ExtensionModelExtStructuralMetadata>();
...
TEST_CASE("Test PropertyTableView with callback for scalar property") {
  Model model;
  std::vector<uint32_t> values = {12, 34, 30, 11, 34, 34, 11, 33, 122, 33};
...
TEST_CASE("Test PropertyTableView with callback for vecN property") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for matN property") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for boolean property") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for string property") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for scalar array") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for vecN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for matN array") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for boolean array") {
  Model model;
...
TEST_CASE("Test PropertyTableView with callback for array of strings") {
  Model model;
